...
#ifndef INC_DRIVERS_SSD1351_H_
#define INC_DRIVERS_SSD1351_H_
...
extern void ssd1351_init(spi_device_handle_t spi);
extern void ssd1351_spi_pre_transfer_callback(spi_transaction_t *t);

#endif /* INC_DRIVERS_SSD1351_H_ */
